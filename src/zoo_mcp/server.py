...
async def calculate_cad_physical_properties(
    ...
    The response identifies this shared frame in its ``coordinate_system`` field.
    ...
    Returns:
        dict | str: A dictionary with keys 'volume', 'mass', 'surface_area',
            'center_of_mass', 'bounding_box', and 'coordinate_system', or an
